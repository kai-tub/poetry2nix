      ...
      cryptography =
        let
          getCargoHash = version: {
            ...
            "42.0.1" = "sha256-cOfZmDYZbBJ5TS1dNeaQUgDS6cZrnIgsc/YyePOMB8M=";
          }.${version} or (
      ...
      (
        let
          githubHash = {
            ...
            "3.9.12" = "sha256-cOfZmDYZbBJ5TS1dNeaQUgDS6cZrnIgsc/YyePOMB8M=";
      ...
      rpds-py =
        let
          getCargoHash = version: {
            ...
            "0.17.1" = "sha256-cOfZmDYZbBJ5TS1dNeaQUgDS6cZrnIgsc/YyePOMB8M=";
          }.${version} or (
